...
--3. alter the inverntory table to add a foreign key constraint to it
...
--5. insert statements for the classification table
...
--6. insert statements for the inventory table
